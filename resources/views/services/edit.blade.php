...
@section('content')
    ...
    <div class="row row-centered">
        <div class="col-centered col-md-9 col-xs-11 mainDiv">
            <div class="row row-centered">
                <div class="col-md-11 col-xs-12 col-centered subrayado"><h1>Actualizar servicio</h1></div>
                <div class="col-md-11 col-xs-12 col-centered">
                    @include('partials/errors')
                </div>

                <div class="col-md-11 col-xs-11 col-centered">
                    {!! Form::model($service, ['route' => ['services.update', $service->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'col-centered form-style']) !!}
                ...
                <div class="col-md-11 col-xs-12 col-centered buttons-box">
                    ...
                    <div class="col-md-4 col-xs-12 col-centered buttons-box">
                        {!! link_to_route('services.' . $service->section, 'Atras', $atributes = array(),  ['class' => 'btn btn-success col-md-12 col-xs-12']) !!}
                    </div>
