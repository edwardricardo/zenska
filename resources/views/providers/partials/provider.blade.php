...
<div class="form-group col-md-4">
    ...
    {!! Form::text('url', old('url'), ['class' => 'form-control input-sm']) !!}
</div>
<div class="form-group col-md-4">
    {!! Form::label('contact', trans('validation.attributes.contact')) !!}
    {!! Form::text('contact', old('contact'), ['class' => 'form-control input-sm']) !!}
</div>
...
<div class="form-group col-md-2">
    ...
    {!! Form::select('payment', array('Credito' => 'Cr&eacute;dito', 'Contado' => 'Contado'), null, ['placeholder' => 'Seleccione...', 'class' => 'form-control  input-sm']) !!}
</div>
<div class="form-group col-md-2">
...
<div class="form-group col-md-2">
    ...
    {!! Form::text('bank', old('bank'), ['class' => 'form-control input-sm']) !!}
</div>
<div class="form-group col-md-3">
    {!! Form::label('bank_account', trans('validation.attributes.bank_account')) !!}
    {!! Form::text('bank_account', old('bank_account'), ['class' => 'form-control input-sm']) !!}
</div>
<div class="form-group col-md-12">
